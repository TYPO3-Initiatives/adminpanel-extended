...
if (TYPO3_MODE === 'FE') {
    $GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['tslib/class.tslib_fe.php']['connectToDB'][] = \Psychomieze\AdminpanelExtended\Hooks\DoctrineDebugHook::class .
                                                                                             '->modifyConnection';
    $GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['adminpanel']['modules'] = \array_replace_recursive(
        $GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['adminpanel']['modules'],
        [
            'admext_doctrinedebug' => [
            ...
            'info' => [
                'module' => \Psychomieze\AdminpanelExtended\Modules\InfoModule::class,
            ]
        ]
    );
